...
($4$) $s:\R^2 \to \R$ 이 $s(x,\,y) = x+y$ 이면 $s'(a,\,b)= s$ 이다.

($5$) $p:\R^2 \to \R$ 이 $p(x,\,y) = x \cdot y$ 이면 $p'(a,\,b) (x,\,y) = bx+ay$ 이다. 따라서 $p'(a,\,b)= (b,\,a)$ 이다. 
...
이다. 우리는 $|h|^2+|k|^2 \le 2|hk|$ 임을 안다. 따라서 위의 극한은 $0$ 이므로 $p'(a,\,b)(x,\,y) = bx+ay$ 이다. $\square$

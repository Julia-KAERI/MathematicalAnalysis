...
### 집합족 {#sec-part1_collection}

::: {.callout-note appearance="simple" icon="false"}

::: {#def-part1_collection_and_indexing}
...
::: {#def-part1_union_and_intersection_for_collection}
...
::: {.callout-note appearance="simple" icon="false"}
::: {#def-part1_omega_tuple_and_sequence}
...
($a$) $\mathbb{Z}^\omega \subset \mathbb{R}^\omega$ (see @exr-part1_munkres_1_5_3).
